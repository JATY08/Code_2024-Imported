    ...
    while (true) {
      ...
      try {
        if (isCANFD) {
          ...
          Thread.sleep((long) (1000.0 / SwervePod.ODOMETRY_FREQUENCY));
...
public Queue<Double> registerSignal(TalonFX thrustTalonFX, StatusSignal<Angle> position) {
    // TODO Auto-generated method stub
    throw new UnsupportedOperationException("Unimplemented method 'registerSignal'");
}
}
