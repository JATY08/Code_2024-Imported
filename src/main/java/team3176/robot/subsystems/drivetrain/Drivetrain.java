...
public class Drivetrain extends SubsystemBase {
  ...
  public static final double LENGTH =
      switch (Constants.getRobot()) {
        case ROBOT_2025C -> Units.inchesToMeters(23);
    ...
    if (Constants.getMode() != Mode.REPLAY) {
      switch (Constants.getRobot()) {
        ...
        case ROBOT_DEFENSE:
          System.out.println("[init] normal swervePods");
          podFR =
              new SwervePod(0, new SwervePodIOTalon(Hardwaremap.POD004, Hardwaremap.STEER_FR_CID));
          podFL =
              new SwervePod(1, new SwervePodIOTalon(Hardwaremap.POD005, Hardwaremap.STEER_FL_CID));
          podBL =
              new SwervePod(2, new SwervePodIOTalon(Hardwaremap.POD007, Hardwaremap.STEER_BL_CID));
          podBR =
              new SwervePod(3, new SwervePodIOTalon(Hardwaremap.POD003, Hardwaremap.STEER_BR_CID));
          break;
        case CTRL_BOARD:
        case ROBOT_SIMBOT:
