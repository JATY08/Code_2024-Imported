...
public class LoggedAprilPhotonCam {
  ...
  private PhotonCameraIO photoio;
  private TimeOfFlightIO tofio;
  ...
  public LoggedAprilPhotonCam(String name, Transform3d robot2Camera) {
    ...
    this.photoio = new PhotonCameraIO(name);
  ...
  public PhotonCamera getCamera() {
    return photoio.getCamera();
  }
  
  public TimeOfFlight getTimeOfFlight() {
    return tofio.getTimeOfFlight();
  }

  public double getdistance(){
    return tofio.getdistance();
  }
  ...
  public void periodic() {
    LogCameraPose();
    photoio.updateInputs(inputs);
    tofio.getdistance();
    System.out.println(tofio.getdistance());
    Logger.processInputs("photonvision/" + this.name, inputs);
    PhotonPipelineResult results = photoio.getResult(inputs.rawBytes);
